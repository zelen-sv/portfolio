<template>
  <header class="header">
    ...
    <h1 class="section__h1 only-for-desktop">
      Hello, I’m a Stas Zelenko<br>
      Full stack Web Developer
    </h1>
    <h1 class="section__h1 only-for-mobile">
      Stas Zelenko
    </h1>
    ...
    <a href="mailto:st.zelenko@gmail.com">
      <v-button text="Say Hi!" />
    </a>
  </header>
</template>
